module.exports = app => {
  ...
  router.get('/news/list', async (req, res) => {
    ...
    const subCats = cats.map(elem => elem._id)
    cats.unshift({
      name: '热门',
  ...
  router.get('/heroes/init', async (req, res) => {
    ...
    for (let cat of rawData) {
      ...
      cat.heroes = cat.heroes.map(elem => {
        elem.categories = [category]
        return elem
      })
